...
export default function Contact() {
  ...
  return (
    <footer
      ...
      id="contact"
    >
      <div className="fixed bottom-0 left-0 w-full h-[100dvh] md:h-[900px] bg-[#050505] overflow-hidden flex flex-col justify-end">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 items-center my-auto">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-sm relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3 md:gap-4">
                <div className="flex flex-col gap-1">
                  <label htmlFor="name" className="text-xs md:text-sm text-white/60 ml-1">Name</label>
                  <input 
                    type="text" 
                    id="name" 
                    name="name" 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 md:py-3 text-white placeholder:text-white/20 focus:outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400 transition-all text-sm md:text-base"
                  />
                </div>

                <div className="flex flex-col gap-1">
                  <label htmlFor="senderEmail" className="text-xs md:text-sm text-white/60 ml-1">Email</label>
                  <input 
                    type="email" 
                    id="senderEmail" 
                    name="senderEmail" 
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="message" className="text-xs md:text-sm text-white/60 ml-1">Message</label>
                  <textarea 
                    id="message" 
                    name="message" 
                    required
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 md:py-3 text-white placeholder:text-white/20 focus:outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400 transition-all resize-none text-sm md:text-base"
                  />
                </div>
                ...
                <button 
                  ...
                  className="mt-1 group flex items-center justify-center gap-2 w-full bg-white text-black px-6 py-3 md:py-4 rounded-xl font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base"
                >
                  {isPending ? (
                    <>
          ...
          {/* Bottom Footer Bar */}
          <div className="w-full flex flex-col md:flex-row justify-between items-center mt-auto pb-6 pt-6 border-t border-white/10 text-white/40 text-xs md:text-sm">
